...
![Граф выполнения](./screenshots/telegram-cloud-photo-size-2-5348400496449884183-y.jpg)

*Наблюдайте за сотрудничеством AI-агентов в реальном времени с детальным отслеживанием задач*

### Главная панель проекта

![AstraMind Dashboard](./screenshots/telegram-cloud-photo-size-2-5348400496449884185-y.jpg)

*Главная страница с доступными проектами и шаблонами для быстрого старта*

### Создание и настройка проекта

![Настройка проекта](./screenshots/telegram-cloud-photo-size-2-5348400496449884823-y.jpg)
...
*Выбирайте из 9+ предусмотленных агентов для вашего проекта*

### Интеграция редактора кода

![Редактор кода](./screenshots/telegram-cloud-photo-size-2-5348400496449884892-y.jpg)
